...
│   ├── install-restore-theme-identity.sh # sourced by the above: renders themes/dark/theme.conf into settings.ini + xsettingsd.conf
...
│                        # dwm-colorpicker.sh, dwm-display.sh
